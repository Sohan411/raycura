...
def-env activate-virtualenv [] {
    ...
    let virtual_env = 'C:\Users\prash\Envs\project_raycura'
    let bin = 'Scripts'
    let path_sep = ';'
    ...
    let virtual_prompt = if ('project_raycura' == '') {
...
alias deactivate = source 'C:\Users\prash\Envs\project_raycura\Scripts\deactivate.nu'
